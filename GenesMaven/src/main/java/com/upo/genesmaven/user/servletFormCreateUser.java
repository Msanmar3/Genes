 ...
 */
public class servletFormCreateUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session != null) {
            ...
            request.getSession().setAttribute("section", "sectionCreateUser.jsp");
            request.getSession().removeAttribute("funcionesJS");
            request.getSession().setAttribute("funcionesJS", "validacionCrearUsuario.js");
            redirect = "inicio.jsp";
