 ...
 */
package com.upo.genesmaven.genes;
 ...
 */
public class servletListGenes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session != null) {
            ...
            request.getSession().setAttribute("filesList", fjpc.findFilesByUser(us.getIdUser()));
            request.getSession().removeAttribute("section");
            request.getSession().setAttribute("section", "sectionListGenes.jsp");
            redirect = "inicio.jsp";
