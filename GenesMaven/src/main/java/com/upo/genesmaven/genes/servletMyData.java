 ...
 */
public class servletMyData extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session != null) {
            ...
            request.getSession().setAttribute("filesList", fjpc.findFilesByUser(id));
            request.getSession().removeAttribute("section");
            request.getSession().setAttribute("section", "sectionMyData.jsp");
